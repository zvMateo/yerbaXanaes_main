...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gray-900 text-gray-300 flex flex-col shadow-xl h-full border-r border-gray-800">
      {/* ✅ Header más compacto */}
      <div className="p-4 border-b border-gray-700">
        ...
        <div className="relative" ref={profileMenuRef}>
          <button
            ...
            className="w-full flex items-center p-3 rounded-xl bg-gray-800/50 hover:bg-gray-700/50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 backdrop-blur-sm border border-gray-700/50"
          >
            {/* ✅ Foto más pequeña */}
            <div className="w-9 h-9 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0 ring-2 ring-gray-600/50">
              {!imageError ? (
                <img
