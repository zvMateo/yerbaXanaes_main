...
const OrderDetailPage = () => {
  ...
  const handleContact = () => {
    ...
    if (order.status === "pending") {
      message +=
        " Tu pedido ha sido confirmado y se está preparando. Te mantendremos informado del progreso.";
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  ...
                  <div className="space-y-4">
                    {[1, 2].map((i) => (
                      <div
                        key={i}
                        className="flex space-x-4 p-4 border border-gray-100 rounded-lg"
                      >
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${typeInfo.color}`}
                    >
                      <typeInfo.icon className="h-3 w-3 mr-1.5" />
                      {typeInfo.label}
                    </span>
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${deliveryInfo.color}`}
                    >
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {isEditing ? "Cancelar" : "Editar Estado"}
                </span>
        ...
        <div
          className={`bg-white rounded-xl shadow-sm border-l-4 p-6 mb-6 ${statusInfo.color
            .replace("bg-", "border-")
            .replace("text-", "border-")}`}
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-4">
              <div
                className={`p-3 rounded-full ${statusInfo.color
                  .replace("text-", "bg-")
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    {order.items.map((item, index) => (
                      <div
                        key={index}
                        className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors duration-200"
                      >
                    ...
                    {timeline.map((step, index) => {
                      ...
                      return (
                        <div key={index} className="relative">
                          ...
                          <div className="flex items-start space-x-4">
                            <div
                              className={`p-3 rounded-full ${orderStatuses[
                                step.status
                              ].color
                                .replace("text-", "bg-")
                                .replace(
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              <button
                ...
                className="w-full px-6 py-4 flex items-center justify-between border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200 xl:cursor-default xl:hover:bg-white xl:border-b-0"
              >
                <h3 className="text-lg font-semibold text-gray-900">Cliente</h3>
                <ChevronDown
                  className={`h-5 w-5 text-gray-400 transition-transform duration-200 xl:hidden ${
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`${
                  expandedSections.orderInfo ? "block" : "hidden xl:block"
                }`}
              >
                <div className="p-6 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${typeInfo.color} self-start sm:self-auto`}
                    >
                      <typeInfo.icon className="h-3 w-3 mr-1.5" />
                      {typeInfo.label}
                    </span>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${deliveryInfo.color} self-start sm:self-auto`}
                    >
                      <deliveryInfo.icon className="h-3 w-3 mr-1.5" />
                      {deliveryInfo.label}
                    </span>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`${
                  expandedSections.shipping ? "block" : "hidden"
                } xl:block`}
              >
                <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`${
                  expandedSections.payment ? "block" : "hidden"
                } xl:block`}
              >
                <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`${
                  expandedSections.tracking ? "block" : "hidden"
                } xl:block`}
              >
                <div className="p-6">
                  {isEditing ? (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`${
                  expandedSections.notes ? "block" : "hidden"
                } xl:block`}
              >
                <div className="p-6">
                  {isEditing ? (
